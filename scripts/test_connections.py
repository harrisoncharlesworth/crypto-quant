...
async def test_binance_connection():
    ...
    try:
        ...
        print(f"   ✅ Private API works - Account connected successfully")
        
        # Show balances if any
        non_zero_balances = {asset: balance for asset, balance in balance['total'].items() if balance > 0}
...
async def test_trading_simulation():
    ...
    try:
        ...
        await notifier.send_risk_alert(
            message="Portfolio exposure at 15% (within limits)",
            severity="INFO"
        )
